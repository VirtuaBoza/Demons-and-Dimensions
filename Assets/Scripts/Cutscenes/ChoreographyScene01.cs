...
public class ChoreographyScene01 : Choreographer {
	...
	void Start() {
		speechBubbles.Add(crystal,crystal.GetComponentInChildren<SpeechBubble>().gameObject);
		speechBubbles.Add(damien,damien.GetComponentInChildren<SpeechBubble>().gameObject);
		speechBubbles.Add(hunter,hunter.GetComponentInChildren<SpeechBubble>().gameObject);
		speechBubbles.Add(teddy,teddy.GetComponentInChildren<SpeechBubble>().gameObject);
